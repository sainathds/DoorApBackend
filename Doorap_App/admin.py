...
class MyUserAdmin(BaseUserAdmin):
    fieldsets = (
        (None, {'fields': ('id', 'name', 'email', 'is_vendor', 'is_customer', 'firebase_token','is_staff', 'customer_login_type','customer_login_id','vendor_login_id','vendor_login_type','last_login','stripe_customer_id','login_id','login_type')}),
        ('Permissions', {'fields': (
            'is_superuser',
            'groups', 
            'user_permissions',
    ...
    list_display = ('id','name','email','password',  'is_vendor', 'is_customer', 'firebase_token','is_staff', 'customer_login_type','customer_login_id','vendor_login_id','vendor_login_type','last_login','stripe_customer_id','login_id','login_type')
    readonly_fields = ('id',)
...
class NotificationAdmin(admin.ModelAdmin):
    list_display = ['id','fk_user','title_name','notification','notification_date','is_seen','user_type']
